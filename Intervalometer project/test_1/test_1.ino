...
if (state){
  if (currentTime - previousTime >= 2000){digitalWrite(relayPin, HIGH);}
  if (currentTime - previousTime >= interval){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
void readinput() {
  byte0 = !digitalRead(A0) * 1;
  byte1 = !digitalRead(A1) * 2;
  byte2 = !digitalRead(A2) * 2 * 2;
  byte3 = !digitalRead(A3) * 2 * 2 * 2;
  byte4 = !digitalRead(A4) * 2 * 2 * 2 * 2;
  byte5 = !digitalRead(A5) * 2 * 2 * 2 * 2 * 2;
